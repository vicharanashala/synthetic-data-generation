# self_instruct_paraphrase_2.py
# Purpose : Expand seed Q&A pairs into diverse paraphrase variants.
# Run     : python self_instruct_paraphrase_2.py
#
# FIXES vs v1:
...
#   5. Grounding — KVK disclaimers and ungrounded % figures banned in system prompt
...
STYLES = [
    ...
    },
    {
        ...
        "description": (
            ...
            "The answer should diagnose from seed content and give management steps. "
            "STRICT: Do NOT add new facts not in the seed."
        ),
    },
    {
        ...
        "description": (
            ...
            "a basic answer. Pick ONE specific detail from the seed answer (a chemical, "
            "dosage, timing, method, or crop condition) and make that the sole focus. "
            "IMPORTANT: Each call must target a DIFFERENT detail — do not repeat the "
            "same follow-up as previous calls for this seed. "
...
VARIATION_HINTS = [
    "First attempt — establish the core framing.",
    "Second attempt — use a different opening word and sentence structure.",
    "Third attempt — approach from a different sub-topic within the seed.",
    "Fourth attempt — change the perspective (field level vs lab level vs farmer vs officer).",
    "Fifth attempt — use shorter sentences and simpler vocabulary than before.",
    "Sixth attempt — focus on a detail you have NOT highlighted in previous attempts.",
    "Seventh attempt — reorder the information flow completely.",
    "Eighth attempt — emphasise a different symptom, cause, or remedy than before.",
    "Ninth attempt — make the question more specific and the answer more concise.",
    "Tenth attempt — take the most general angle possible, broad scope.",
]
