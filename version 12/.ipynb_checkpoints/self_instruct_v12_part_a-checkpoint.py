# self_instruct_v12_part_a.py
# Purpose : Expand seed Q&A pairs into diverse paraphrase variants.
#           PART A — processes seeds 1 to 150 (indices 0–149).
#           Auto-resumes from last checkpoint if interrupted.
# Run     : python self_instruct_v12_part_a.py
#
# CHANGES vs v11:
...
OUT_JSON        = "/home/kritika/self_instruct/paraphrase_v12_part_a.json"
OUT_CSV         = "/home/kritika/self_instruct/paraphrase_v12_part_a.csv"
OUT_LOG         = "/home/kritika/self_instruct/paraphrase_v12_part_a_log.txt"

SEED_START          = 0    # inclusive index into the CSV (0-based)
SEED_END            = 150  # exclusive — processes seeds at index 0..149 (rows 1–150)
...
def main():
    ...
    print(f"\n{'='*60}")
    print(f"  Self-Instruct Paraphrase v12 — PART A (seeds {SEED_START+1}–{SEED_END})")
